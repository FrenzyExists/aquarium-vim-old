...
call s:hi("CursorIM", s:aquarium_black, s:aquarium_bg_dim, "", "NONE", "", "") " like Cursor, but used when in IME mode
...
call s:hi("markdownHeadingRule", s:aquarium_cyan, "", "", "", "", "")
